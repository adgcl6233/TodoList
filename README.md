...
### 3. 筛选和排序
- **分类筛选** - 点击分类按钮查看特定分类的任务
- **完成状态筛选** - 选择查看全部/未完成/已完成任务
- **排序方式** - 按创建时间或截止时间排序，并可切换升序/降序
...
> **提示**：要获取真实的应用截图，请在浏览器中打开 http://localhost:3000，然后使用浏览器的截图功能（Windows: Win+Shift+S, Mac: Cmd+Shift+4）
